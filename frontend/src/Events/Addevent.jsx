...
function Addevent() {
    ...
    const handleBooking = async (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                setShowModal(!showModal);
                navigate('/dashboard/customEvent');
            }
        });
    ...
    return (
        ...
        //         height: 400
        //     }}>
        //         <div className='h-[400px]  bg-opacity-70 relative bg-opacity-70 custom-container1' >
        //             <div className='absolute top-60 left-8 md:left-36 custom-position' >
        //                 <h1 className='text-5xl text-white font-bold custom-heading'>Create Your Event</h1>
        //                 <p className='text-xl mt-2 flex items-center gap-2 text-white custom-text1'>Home <CiPlay1 className='text-pink-600' style={{color:'red'}}/> <span className='text-red-500' style={{color:'red'}}>Create your event</span></p>
        //             </div>
        //         </div>
        //     </div>
        //     <div className='max-w-screen-xl mx-auto my-6'>
        //         <h2 className='text-3xl font-semibold ' >Let us know about your event</h2>
        //         {/* <h2  style={{fontSize:'28px',fontWeight:'700',float:'left'}}>Let us know about your event</h2> */}
        //         <div className='grid md:grid-cols-5 p-2 gap-12 my-8' style={{display:'flex'}}>
        //             <div className='col-span-3 '>
        //                 <div>
        //                     <div className="border rounded-lg bg-rose-50/50 border-gray-400 p-4 custom-container">
        //                         <h2 className="text-base font-semibold leading-7 text-gray-900 custom-text">Fill up this form</h2>
        //                         <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        //                             <div className="sm:col-span-3">
        //                                 <label className="block text-sm font-medium leading-6 text-gray-900">Event Type</label>
        //                                 <div className="mt-2">
        //                                     <select onChange={handleEventType} className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2 custom-input' name="type" id="">
        ...
        //                                 <div className="mt-2">
        //                                     <input onChange={handleInputDate} type="date" name="date" id="last-name" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-2 custom-input" />
        //                                 </div>
        //                             </div>
        ...
        //                                 <div className="mt-2 relative">
        //                                     <select onChange={handleGuestCount} id="guests" name="guests" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-5 custom-input">
        ...
        //                                 <div className="mt-2">
        //                                     <select onChange={handleInputPhotography} className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2 custom-input' name="" id="">
        ...
        //                             <div className="sm:col-span-3">
        //                                 <label className="block text-sm font-medium leading-6 text-gray-900">Catering Services</label>
        //                                 <div className="mt-2">
        //                                     <select onChange={handleCatering} className='block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2 custom-input' name="" id="">
        ...
        //                                 <input type="text" id="phone" name="phone" className="mt-1 p-2 bg-rose-100 w-full border border-gray-300 placeholder:text-sm rounded-md" placeholder='write your phone' required />
        //                             </div>
        //                             <div className="mt-6">
        ...
        <div className='max-w-screen-xl mx-auto my-6'>
            ...
            <div className='grid md:grid-cols-5 p-2 gap-12 my-8' style={{display:'flex'}}>
                <div className='col-8'>
                    <div>
                        <div className="border rounded-lg bg-rose-50/50 border-gray-400 p-4">
                            ...
                            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div className="sm:col-span-3">
                                    <label className="block text-sm font-medium leading-6 text-gray-900" style={{float:'left'}}>Event Type</label>
                                    <div className="mt-2">
                                ...
                                <div className="sm:col-span-3">
                                    <label className="block text-sm font-medium leading-6 text-gray-900" style={{float:'left'}}>Date</label>
                                    <div className="mt-2">
                                ...
                                <div className="sm:col-span-3">
                                    <label className="block text-sm font-medium leading-6 text-gray-900" style={{float:'left'}}>Location</label>
                                    <div className="mt-2 relative">
                                        <input onChange={handleInputLocation} id="location" placeholder='Type your event location' name="location" type="location" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-6" />
                                        <CiLocationOn className='absolute top-7 left-1' />
                                    </div>
                                </div>

                                <div className="sm:col-span-3">
                                    <label className="block text-sm font-medium leading-6 text-gray-900" style={{float:'left'}}>Total Guests</label>
                                    <div className="mt-2 relative">
                                        ...
                                        <CiUser className='absolute top-6 left-1' />
                                    </div>
                                </div>
                                <div className="sm:col-span-3">
                                    <label className="block text-sm font-medium leading-6 text-gray-900" style={{float:'left'}}>Photography and Videography</label>
                                    <div className="mt-2">
                                ...
                                <div className="sm:col-span-3">
                                    <label className="block text-sm font-medium leading-6 text-gray-900"  style={{float:'left'}}>
                                        Catering Services
                                    </label>
                                    <div className="mt-2">
                ...
                <div className='md:col-span-2 col-4 p-4 md:p-0 bg-rose-50/50  rounded-lg border-gray-400 border'>
                    <div className="w-full  rounded-lg  sm:p-12 ">
                        <h5 className="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400" >Estimated Cost</h5>
                        <div className="flex items-baseline text-gray-900 dark:text-white">
                            <span className="text-3xl font-semibold">$</span>
