    ...
    <div>
      <div className="">
        ...
        <div className="-mt-[75px] md:-mt-40">
          <h2 className="text-xl md:text-4xl text-center " style={{fontSize:'34px'}}>About Us</h2>
          <h3 className="text-xl md:text-3xl font-semibold text-center  font-serif" style={{color:'#9C0C0D',fontSize:'32px'}}>
            SunFlower Events
          </h3>
      ...
      <div className=" p-3 space-y-7 mt-5 md:mt-20  md:max-w-6xl mx-auto">
        ...
        {/* 2 */}
        <div className="md:flex flex-row-reverse gap-5 " style={{textAlign:'left'}}>
          <div className="h-full w-full">
        ...
        {/* 3 */}
        <div className="md:flex gap-5 " style={{textAlign:'left'}}>
          <div className="h-full w-full">
        ...
        {/* 4 */}
        <div className="md:flex gap-5 flex-row-reverse justify-center" style={{textAlign:'left'}}>
          <div className="h-full w-full">
      ...
      <p className="text-xl ">
      We are an exclusive, independent event planning company based in Kerala, specializing in premium wedding services, birthday parties, and perfect party organizing tailored to the needs of our clients. With a touch of personalization, we create stylish, exclusive, and creative events throughout Kerala. Our award winning team of event management and wedding planners offers a highly creative, friendly, and professional service dedicated to making every event memorable. At Kerala Love to Plan, we are passionate about bringing dreams to life.
      </p>
    </div>
      </div>
