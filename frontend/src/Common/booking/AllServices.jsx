...
const AllServices = () => {
  return (
    <Container>
      ...
      <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-24 m-3 lg:m-12" style={{display:'flex'}}>
        {/* card 1  */}
        <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
          <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
            ...
            /> */}
            <img
              src='https://img.freepik.com/free-photo/photorealistic-wedding-venue-with-intricate-decor-ornaments_23-2151481534.jpg?t=st=1719160742~exp=1719164342~hmac=93b12d6bcf314a0c830928cd275a6304c3c890277cc7510df8dbcc1321dc854e&w=826'
              alt=""
              className="rounded-t-md h-full w-full object-cover transform transition-transform duration-500 hover:scale-110"
            />
        ...
        <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
          <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
            ...
            /> */}
            <img
              src="https://img.freepik.com/free-photo/people-taking-part-high-protocol-event_23-2150951233.jpg?t=st=1719161028~exp=1719164628~hmac=606a5d41eba61b07fc4ab7b15daca6509e6715f579ebe4d3fbe263b131cdde32&w=826"
              alt=""
              className="rounded-t-md h-full w-full object-cover transform transition-transform duration-500 hover:scale-110"
            />
...
<div  className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-24 m-2 lg:m-12" style={{display:'flex'}}>
        {/* card 3  */}
        <div className="rounded-md shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-lg bg-white hover:bg-gray-100">
          <div className="rounded-t-md shadow-lg h-60 relative overflow-hidden ">
            {/* <img
            ...
            /> */}
            <img
              src="https://img.freepik.com/free-photo/photorealistic-wedding-venue-with-intricate-decor-ornaments_23-2151481455.jpg?t=st=1719161198~exp=1719164798~hmac=341e8f8c571f755305ec8960a82099b416aea53b4b547f48278493241fc4fe57&w=826"
              alt=""
              className="rounded-t-md h-full w-full object-cover transform transition-transform duration-500 hover:scale-110"
            />
